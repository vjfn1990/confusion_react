            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                            ...
                            <i className="fa fa-envelope"></i>: <a href="https://www.google.com">confusion@food.net</a>
                            </address>
                    </div>
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            <a role="button" className="btn btn-primary" href="https://www.google.com"><i className="fa fa-phone"></i> Call</a>
                            <a role="button" className="btn btn-info" href="https://www.google.com"><i className="fa fa-skype"></i> Skype</a>
                            <a role="button" className="btn btn-success" href="https://www.google.com"><i className="fa fa-envelope-o"></i> Email</a>
                        </div>
                    </div>
                </div>
                <div className="row row-content">
